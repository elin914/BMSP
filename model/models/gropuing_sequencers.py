...
class BaseGroupingSequencer:
    def get_sequence_list(self, grouper, job_list: List[Job], machines) -> List[int]: raise NotImplementedError


class EDDGroupingSequencer(BaseGroupingSequencer):
    """Due Date가 빠른 순서대로 정렬"""
    def get_sequence_list(self, grouper, job_list: List[Job], machines) -> List[int]:
