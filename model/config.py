...
class Config:
    def __init__(self):
        self.random_seed = 42
        self.data_file_path = '../data/binpacktwo.xls'
        # cgcut: 1~3, gcut: 1~13, ngcut: 1~12
        self.data_type = 'cgcut2'
    ...
    def save_config(self, name=None):
        ...
        save_path = self.result_folder_path + '/configuration.xlsx' if name is None else self.result_folder_path + '/' + name + '.xlsx'
